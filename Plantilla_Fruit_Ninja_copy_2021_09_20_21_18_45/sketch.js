...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, brutalImage, brutalSound;
...
function preload(){
  ...
  brutalImage = loadImage("brutal.jpg")

  //carga aquí el sonido
  brutalSound = loadSound("brutal.ogg")
}
